...
})({"4XkAe":[function(require,module,exports) {
(function(scope) {
    "use strict";
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Models$Main$toModel = $elm$json$Json$Decode$int;
    var $author$project$Main$init = function(f) {
        var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Models$Main$toModel, f);
        if (_v0.$ === "Ok") {
            var m = _v0.a;
            return _Utils_Tuple2($author$project$Main$Ready(m), $elm$core$Platform$Cmd$none);
        } else return _Utils_Tuple2($author$project$Main$Error, $elm$core$Platform$Cmd$none);
    };
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        if (model.$ === "Ready") {
            var m = model.a;
            if (msg.$ === "Increment") return _Utils_Tuple2($author$project$Main$Ready(m + 1), $elm$core$Platform$Cmd$none);
            else return _Utils_Tuple2($author$project$Main$Ready(m - 1), $elm$core$Platform$Cmd$none);
        } else return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
    });
        ...
        if (model.$ === "Ready") {
            ...
            return A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                ...
                A2($elm$html$Html$div, _List_Nil, _List_fromArray([
                    $elm$html$Html$text($elm$core$String$fromInt(m))
                ])),
                A2($elm$html$Html$button, _List_fromArray([
...
},{}]},[], null, "parcelRequire6d93")

//# sourceMappingURL=Main.26f7aba8.js.map
